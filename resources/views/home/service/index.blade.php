                        ...
                        <div class="filter-container" style="display:flex;flex-direction:column">
                            ...
                            <form>
                                <div class="filter-item d-flex">
                                    ...
                                    <input type="text" name="keyword" value="{{ request()->keyword }}" class="form-control" placeholder="keyword" >
                                    <input type="number" class="form-control" name="min_price" id="min_price"
                                        class="input_price" placeholder="min price" value="{{ request()->min_price }}">
                                    <span> - </span>
                                    <input type="number" class="form-control" name="max_price" id="max_price"
                                        class="input_price" value="{{ request()->max_price }}" placeholder="max price">
                        ...
                        <div class="faq-container">
                            @foreach ($services as $item)
                                <div class="faq-item faq-active" data-aos="fade-up" data-aos-delay="200">
                                    <img src="{{ $item->thumbnail }}" alt="gambar-service">
