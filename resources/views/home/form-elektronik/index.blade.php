@extends('home.layout.form-elektronik')
@section('content')
    <!-- Page Title -->
            ...
            <div class="form-box-elektronik">
                <form class="form" action="" method="post">
                    <div class="head-form">
                        <div class="deskripsi">
                            <p>
                                Isi formulir dibawah ini dengan sungguh-sungguh, data dari formulir ini akan langsung
                                tersampaikan kepada penyedia layanan
                                service yang dipesan. Untuk metode pembayaran, saat ini hanya bisa melalui <span
                                    style="font-weight: bold; font-style: italic;">Cash On Delivery (COD) atau bayar
                                    ditempat</span>, harap lakukan pembayaran secara langsung ke penyedia layanan servis.
                            </p>
                        </div>
                    </div>
